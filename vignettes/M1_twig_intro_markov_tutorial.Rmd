...
twig_obj <- twig() + 
  ...
  states(names = c("H", "S1", "S2", "D"), initial_probabilities = c(1,0,0,0)) +  
  event(name = "get_event",  
                options = c("recover", "getsick", "progress", "die", "stay"), 
                probabilities = c(pRecover(state), pGetSick(state), pProgress(state, decision), pDie(state), Inf), 
                transitions = c("H", "S1", "S2", "D", "current_state")) +  

...
```
pSick is a simple function here that will return 0.5 if the decision="A", otherwise 0.7.  Later we will show how to create more complex probs that can take into account the value of prior events which will help us keep the code concise.

---
title: "Decision Tree of Herpes Virus Encephalopathy Management"
...
In DecisionTwig, this decision tree looks like this:
![Decision Tree](man/figures/decision_tree_twig.png)
...
# Running the `twig`
We can run the model and check the results of the single parameter set under `results$Rewards_sim`

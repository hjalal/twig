...
```{r}
model_res <- twig_gen_model_function(twig_obj)
model_res
```
...
# Direct coding in R
And here is what the code looks like if one wants to code the transitions all in R directly without using twig
```{r}

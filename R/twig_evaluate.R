...
twig_evaluate <- function(x, ...) UseMethod("twig_evaluate")
...
twig_evaluate.markov_twig <- function(twig_env, model_function_name = "my_markov_model", print_model_function = FALSE){
  ...
  if (is.null(discounts)){
    warning("A discount was not provided. Will assume no discount.  To apply a discount, please add discount() to the twig")
...
#' @param model_num_struc a matrix containing the numerical twig decision object from the twig_parse() function
#' @export
#' 
#' @return twig object
#'
